        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(list != null){
                ...
                for(Order d:list){
                    ...
                    out.print("<td>"+d.getOrderDate().toString()+"</td>");
                    out.print("<td>"+d.getAccid()+"</td>");
                    out.print("<td>"+d.getStatus()+"</td>");
//                    luu order d vao request de transfer qua "DetailView"
                    out.print("<td><a href='DetailView?id="+d.getId()+"'>Detail</td>");
                    out.print("</tr>");
                }
                out.print("</table>");
            }
